...
from protos import weather_pb2 as weather__pb2
...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Give_Weather_Details = channel.unary_unary(
                '/greet.Greeter/Give_Weather_Details',
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Give_Weather_Details': grpc.unary_unary_rpc_method_handler(
                    servicer.Give_Weather_Details,
...
class Greeter(object):
    ...
    @staticmethod
    def Give_Weather_Details(request,
            target,
            options=(),
